...
def generate_pdf(name, username, email):
    ...
    pdf.cell(200, 10, txt="LIPS LIBRARY", ln=1, align="C")
    pdf.cell(200, 20, txt="STUDENT LIBRARY CARD", ln=1, align="C")
    pdf.cell(10, 20, txt="NAME : " + name, ln=2, align="L")
    pdf.cell(10, 20, txt="USERNAME :" + username, ln=2, align="L")
    pdf.cell(10, 20, txt="EMAIL :" + email, ln=2, align="L")
